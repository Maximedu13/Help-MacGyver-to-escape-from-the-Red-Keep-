...
#BAG
BAG_ITEM = "ressource/kisspng-apple-icon-image-format-css-sprites-icon-dollar-\
gold-coin-bags-5a7efeaf340251.9631686615182721752131.jpg"
BAG_TXT = "BAG ="
...
INSTRUCTIONS_END_5 = ["A new day was dawning in King\'s Landing, after a quick \
breakfast taken in her private apartments", "Cersei decided to take a little \
walk over the dungeons beneath the Red Keep", \
"As she slowly approached your prison cell, and in a last desperate attempt to \
escape", "you tried to pick the lock of it. Unfortunately for you, it's too \
late and Cersei sentences you to death."]
INSTRUCTIONS_END_6 = ["Congratulations to you !", "A new day was dawning in \
King\'s Landing, you escaped from your cell", "and get to the docks of King's \
Landing.", "In exchange for the needle made of the items you collected,", \
"you got a cabin on board of and reached the city of Volantis..."]
